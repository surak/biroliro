...
for (var i = 0; i < elements.length; i++) {
    ...
    for (var j = 0; j < element.childNodes.length; j++) {
        ...
        var random = Math.floor(Math.random() * biro.length);
